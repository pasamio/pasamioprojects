...
if(!defined('TABLEEDITOR_ELEMENT_PATH')) define('TABLEEDITOR_ELEMENT_PATH',JPATH_ADMINISTRATOR . DS . 'components' . DS . 'com_tableeditor' . DS .'elements');
 ...
 * @since		1.5
 */
class JInstallerTableEditor_Element extends JObject
{
	/**
	 * Constructor
	 *
	...
	function install()
	{
		...
		$manifest['dest'] = TABLEEDITOR_ELEMENT_PATH.DS.basename($this->parent->getPath('manifest'));
	...
	function uninstall($id, $clientId )
	{
		...
		$row	= null;
		$retval = true;
		$manifestFile = TABLEEDITOR_ELEMENT_PATH . DS . $id .'.xml'; 
